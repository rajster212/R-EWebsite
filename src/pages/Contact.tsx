          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-lg text-navy-700 mb-8">
                Have a question, feedback, or a project idea? We're here to help. Fill out the form, and we'll get back to you as soon as possible.
              </p>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-navy-900 mb-1">Business Hours</h3>
                    <p className="text-navy-700">
              ...
              <div>
                <h3 className="text-lg font-semibold text-navy-900 mb-3">Connect With Us</h3>
                <div className="flex space-x-4">
                  <a href="https://twitter.com" className="bg-blue-100 hover:bg-blue-200 p-3 rounded-full transition-colors">
                  ...
                  <a href="https://linkedin.com" className="bg-blue-100 hover:bg-blue-200 p-3 rounded-full transition-colors">
                    <svg className="h-5 w-5 text-blue-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path>
                    </svg>
                  </a>
                  <a href="https://facebook.com" className="bg-blue-100 hover:bg-blue-200 p-3 rounded-full transition-colors">
                    <svg className="h-5 w-5 text-blue-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                    </svg>
                  </a>
                  <a href="https://instagram.com" className="bg-blue-100 hover:bg-blue-200 p-3 rounded-full transition-colors">
                    <svg className="h-5 w-5 text-blue-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h3 className="text-2xl font-semibold text-navy-900 mb-6">Send Us a Message</h3>
              <ContactForm />
            </div>
          </div>
        </div>
